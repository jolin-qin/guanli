            ...
            <template slot-scope="scope">
              ...
              >绑定微信</el-button> 
               <el-button
                ...
                type="text"
                icon="el-icon-key"
                @click="resetReportUser(scope.row)"
              >解绑微信</el-button> -->
            </template>
          </el-table-column>
        </el-table>
    ...
    <!-- <el-dialog :title="title" :visible.sync="reportUser" width="700px">
      <div>
        <el-form ref="form" :model="form" :inline="true" label-width="80px">
          ...
          <el-form-item>
            <el-button type="primary" @click="handleReportUserSearch">搜索</el-button>
          </el-form-item>
        </el-form>
        <el-row :gutter="10">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="handleReportUserSubmit">确 定</el-button>
...
export default {
  ...
  methods: {
    ...
    roleInputSelect(){
      var that = this;
      this.inputSelectList("sys_user", "role_id", null, function(data){
        that.roleList = data;
      });
    },
    /** 查询用户列表 */
    getList() {
      ...
      listUser(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        console.log('this:',this)
          this.userList = this.shuxinDataFormat("sys_user",response.rows);
...
<style scoped="scoped">
  ...
  .size140{width: 140px;height: 180px;background: #fafafa;}
</style>
